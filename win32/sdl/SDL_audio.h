...
typedef struct SDL_AudioCVT {
	...
	void (SDLCALL *filters[10])(struct SDL_AudioCVT *cvt, u16 format);
...
extern DECLSPEC int SDLCALL SDL_BuildAudioCVT(SDL_AudioCVT *cvt,
		u16 src_format, Uint8 src_channels, int src_rate,
		u16 dst_format, Uint8 dst_channels, int dst_rate);
