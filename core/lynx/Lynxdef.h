...
//		BYTE mATTEN_A       ;    //0xFD40	//
//		BYTE mATTEN_B       ;    //0xFD41
//		BYTE mATTEN_C       ;    //0xFD42  // Lynx2 Regs see macros/handy.equ
//		BYTE mATTEN_D       ;    //0xFD43

		BYTE mMPAN          ;    //0xFD44  //
		BYTE mr0x45[0x50-0x45];
		BYTE mMSTEREO		;    //0xfd50 
		BYTE mr0x51[0x80-0x51];
		BYTE mINTRST		;    //0xfd80 
		BYTE mINTSET		;    //0xfd81 
		BYTE mr0x82[0x84-0x82];
		BYTE mMAGRDY0		;    //0xfd84 
		BYTE mMAGRDY1		;    //0xfd85 
		BYTE mAUDIN			;    //0xfd86 
		BYTE mSYSCTL1		;    //0xfd87 
		BYTE mMIKEYHREV		;    //0xfd88 
		BYTE mMIKEYSREV		;    //0xfd89 
		BYTE mIODIR			;    //0xfd8a 
		BYTE mIODAT			;    //0xfd8b 
		BYTE mSERCTL		;    //0xfd8c 
		BYTE mSERDAT		;    //0xfd8d 
		BYTE mr0x8e[0x90-0x8e];
		BYTE mSDONEACK		;    //0xfd90 
		BYTE mCPUSLEEP		;    //0xfd91 
		BYTE mDISPCTL		;    //0xfd92 
		BYTE mPBKUP			;    //0xfd93 
		BYTE mDISPADRL		;    //0xfd94 
		BYTE mDISPADRH		;    //0xfd95 
		BYTE mr0x96[0x9c-0x96];
		BYTE mMtest0		;    //0xfd9c 
		BYTE mMtest1		;    //0xfd9d 
		BYTE mMtest2		;    //0xfd9e 
		BYTE mr0x9f;
