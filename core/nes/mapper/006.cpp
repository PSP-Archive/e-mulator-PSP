STATIC void NES_mapper6_Init();
STATIC void NES_mapper6_Reset();
STATIC void NES_mapper6_MemoryWriteLow(u32 addr, u8 data);
STATIC void NES_mapper6_MemoryWrite(u32 addr, u8 data);
STATIC void NES_mapper6_HSync(u32 scanline);
...
STATIC void NES_mapper6_MemoryWriteLow(u32 addr, u8 data)
{
	...
	case 0x4502:
		{
			g_NESmapper.Mapper6.irq_counter = (g_NESmapper.Mapper6.irq_counter & 0xFF00) | (u32)data;
		}
		break;

	case 0x4503:
		{
			g_NESmapper.Mapper6.irq_counter = (g_NESmapper.Mapper6.irq_counter & 0x00FF) | ((u32)data << 8);
...
STATIC void NES_mapper6_MemoryWrite(u32 addr, u8 data)
{
	u8 prg_bank = (data & 0x3C) >> 2;
	u8 chr_bank = data & 0x03;
