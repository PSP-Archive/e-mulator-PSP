...
STATIC void NES_mapper45_MemoryWriteSaveRAM(u32 addr, u8 data)
{
	if(addr == 0x6000)
	{
		...
		NES_mapper45_MAP45_set_CPU_bank4((u8)g_NESmapper.Mapper45.prg0);
		NES_mapper45_MAP45_set_CPU_bank5((u8)g_NESmapper.Mapper45.prg1);
		NES_mapper45_MAP45_set_CPU_bank6((u8)g_NESmapper.Mapper45.prg2);
		NES_mapper45_MAP45_set_CPU_bank7((u8)g_NESmapper.Mapper45.prg3);
...
STATIC void NES_mapper45_MAP45_set_PPU_banks()
{
	...
	for(i = 0; i < 8; i++)
	{
		...
		g_NESmapper.Mapper45.c[i] += (u32)(g_NESmapper.Mapper45.regs[2] & ((g_NESmapper.Mapper45.patch == 0) ? 0x10 : 0x30)) << 4;
	}
