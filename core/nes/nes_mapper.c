...
// NES mapper base
STATIC void  NES_mapper_base_Reset() {};
STATIC u8 NES_mapper_base_MemoryReadLow(u32 addr) {return (u8)(addr >> 8);}
STATIC void  NES_mapper_base_WriteHighRegs(u32 addr, u8 data) {}
STATIC void  NES_mapper_base_MemoryWrite(u32 addr, u8 data) {}
STATIC void  NES_mapper_base_MemoryWriteLow(u32 addr, u8 data) {}
STATIC void  NES_mapper_base_MemoryWriteSaveRAM(u32 addr, u8 data) {}
STATIC void  NES_mapper_base_MemoryReadSaveRAM(u32 addr) {}
STATIC void  NES_mapper_base_HSync(u32 scanline)  {}
STATIC void  NES_mapper_base_VSync() {}
// for mmc2 & mmc5 & Oekakidds
STATIC void  NES_mapper_base_PPU_Latch_FDFE(u32 addr) {}
STATIC u8 NES_mapper_base_PPU_Latch_RenderScreen(u8 mode, u32 addr) {return 0;}
STATIC void  NES_mapper_base_PPU_Latch_Address(u32 addr) {}
// for disk system (#20)
STATIC u8 NES_mapper_base_GetDiskSideNum() {return 0;}
STATIC u8 NES_mapper_base_GetDiskSide() {return 0;}
STATIC void  NES_mapper_base_SetDiskSide(u8 side) {}
STATIC u8 *NES_mapper_base_GetDiskDatap() {return 0;}
STATIC u8 NES_mapper_base_DiskAccessed() {return 0;}
// for Datach Barcode Battler
STATIC void NES_mapper_base_SetBarcodeValue(u32 value_low, u32 value_high) {}

STATIC void NES_mapper_base_set_CPU_banks4(u32 bank4_num, u32 bank5_num,
                               u32 bank6_num, u32 bank7_num)
{
...
STATIC void NES_mapper_base_set_CPU_bank4(u32 bank_num)
{
	nes6502_context context;
...
STATIC void NES_mapper_base_set_CPU_bank5(u32 bank_num)
{
	nes6502_context context;
...
STATIC void NES_mapper_base_set_CPU_bank6(u32 bank_num)
{
	nes6502_context context;
...
STATIC void NES_mapper_base_set_CPU_bank7(u32 bank_num)
{
	nes6502_context context;
...
// for UNIF
STATIC void NES_mapper_base_set_CPU_bank_unif(u32 kn, u8 pagen){
	nes6502_context context;
...
void NES_mapper_base_set_VRAM_bank_unif(u32 kn, u8 pagen){
...
// for mapper 40 /////////////////////////////////////////////////////////
STATIC void NES_mapper_base_set_CPU_banks5(u32 bank3_num,
                               u32 bank4_num, u32 bank5_num,
                               u32 bank6_num, u32 bank7_num)
{
	nes6502_context context;
...
STATIC void NES_mapper_base_set_CPU_bank3(u32 bank_num)
{
	nes6502_context context;
...
STATIC void NES_mapper_base_set_PPU_banks8(u32 bank0_num, u32 bank1_num,
                               u32 bank2_num, u32 bank3_num,
                               u32 bank4_num, u32 bank5_num,
                               u32 bank6_num, u32 bank7_num)
{
...
STATIC void NES_mapper_base_set_PPU_bank0(u32 bank_num)
{
...
STATIC void NES_mapper_base_set_PPU_bank1(u32 bank_num)
{
	VALIDATE_VROM_BANK(bank_num);
...
STATIC void NES_mapper_base_set_PPU_bank2(u32 bank_num)
{
	VALIDATE_VROM_BANK(bank_num);
...
STATIC void NES_mapper_base_set_PPU_bank3(u32 bank_num)
{
	VALIDATE_VROM_BANK(bank_num);
...
STATIC void NES_mapper_base_set_PPU_bank4(u32 bank_num)
{
	VALIDATE_VROM_BANK(bank_num);
...
STATIC void NES_mapper_base_set_PPU_bank5(u32 bank_num)
{
	VALIDATE_VROM_BANK(bank_num);
...
STATIC void NES_mapper_base_set_PPU_bank6(u32 bank_num)
{
	VALIDATE_VROM_BANK(bank_num);
...
STATIC void NES_mapper_base_set_PPU_bank7(u32 bank_num)
{
	VALIDATE_VROM_BANK(bank_num);
...
// for mapper 19,68,90
STATIC void NES_mapper_base_set_PPU_bank8(u32 bank_num)
{
	VALIDATE_VROM_BANK(bank_num);
	g_PPU.PPU_VRAM_banks[8] = g_NESmapper.VROM_banks + (bank_num << 10);
}
STATIC void NES_mapper_base_set_PPU_bank9(u32 bank_num)
{
	VALIDATE_VROM_BANK(bank_num);
	g_PPU.PPU_VRAM_banks[9] = g_NESmapper.VROM_banks + (bank_num << 10);
}
STATIC void NES_mapper_base_set_PPU_bank10(u32 bank_num)
{
	VALIDATE_VROM_BANK(bank_num);
	g_PPU.PPU_VRAM_banks[10] = g_NESmapper.VROM_banks + (bank_num << 10);
}
STATIC void NES_mapper_base_set_PPU_bank11(u32 bank_num)
{
	VALIDATE_VROM_BANK(bank_num);
...
STATIC void NES_mapper_base_set_VRAM_bank(u8 bank, u32 bank_num)
{
	if(bank < 8)
	{
...
STATIC void NES_mapper_base_set_mirroring(u32 nt0, u32 nt1, u32 nt2, u32 nt3)
{
	ASSERT(nt0 < 4);
	ASSERT(nt1 < 4);
	ASSERT(nt2 < 4);
...
STATIC void NES_mapper_base_set_mirroring2(mirroring_type m)
{
	NES_PPU_set_mirroring2(m);
}

STATIC void NES_mapper_base_set_genie()
{
	nes6502_context context;
	u8 genie_num;
	u8 i;
	...
	{
		u32 genie_code = NES_GetGenieCode(i);
		u32 addr = ((genie_code & 0x7FFF0000) >> 16) | 0x8000;
		u8 data1 = genie_code & 0x000000FF;
		u8 data2 = (genie_code & 0x0000FF00) >> 8;
		u8 data3 = context.mem_page[addr >> 13][addr & 0x1FFF];
...
/////////////////////////////////////////////////////////////////////
// g_NESmapperを初期化する。
STATIC void NES_mapper_Init(void)
{
	u32 probe;
	// 一応初期化
	core_memset(&g_NESmapper, 00, sizeof(g_NESmapper));
...
NES_mapper* GetMapper(void)
{
    ...
    if(NES_ROM_get_unifmapper_num()){
        switch(NES_ROM_get_unifmapper_num()){
          case 1:            NES_UNIFmapper1_Init(); return &g_NESmapper;
          case 2:            NES_UNIFmapper2_Init(); return &g_NESmapper;
          case 3:            NES_UNIFmapper3_Init(); return &g_NESmapper;
          case 4:            NES_UNIFmapper4_Init(); return &g_NESmapper;
          default:            return NULL;
        }
    }

    switch(NES_ROM_get_mapper_num()) {
      case 0:        NES_mapper0_Init(); return &g_NESmapper;
      case 1:        NES_mapper1_Init(); return &g_NESmapper;
      case 2:        NES_mapper2_Init(); return &g_NESmapper;
      case 3:        NES_mapper3_Init(); return &g_NESmapper;
      case 4:        NES_mapper4_Init(); return &g_NESmapper;
      case 5:        NES_mapper5_Init(); return &g_NESmapper;
      case 6:        NES_mapper6_Init(); return &g_NESmapper;
      case 7:        NES_mapper7_Init(); return &g_NESmapper;
      case 8:        NES_mapper8_Init(); return &g_NESmapper;
      case 9:        NES_mapper9_Init(); return &g_NESmapper;
      case 10:        NES_mapper10_Init(); return &g_NESmapper;
      case 11:        NES_mapper11_Init(); return &g_NESmapper;
      case 13:        NES_mapper13_Init(); return &g_NESmapper;
      case 15:        NES_mapper15_Init(); return &g_NESmapper;
      case 16:        NES_mapper16_Init(); return &g_NESmapper;
      case 17:        NES_mapper17_Init(); return &g_NESmapper;
      case 18:        NES_mapper18_Init(); return &g_NESmapper;
      case 19:        NES_mapper19_Init(); return &g_NESmapper;
      case 20:        NES_mapper20_Init(); return &g_NESmapper;
      case 21:        NES_mapper21_Init(); return &g_NESmapper;
      case 22:        NES_mapper22_Init(); return &g_NESmapper;
      case 23:        NES_mapper23_Init(); return &g_NESmapper;
      case 24:        NES_mapper24_Init(); return &g_NESmapper;
      case 25:        NES_mapper25_Init(); return &g_NESmapper;
      case 26:        NES_mapper26_Init(); return &g_NESmapper;
      case 32:        NES_mapper32_Init(); return &g_NESmapper;
      case 33:        NES_mapper33_Init(); return &g_NESmapper;
      case 34:        NES_mapper34_Init(); return &g_NESmapper;
      case 40:        NES_mapper40_Init(); return &g_NESmapper;
      case 41:        NES_mapper41_Init(); return &g_NESmapper;
      case 42:        NES_mapper42_Init(); return &g_NESmapper;
      case 43:        NES_mapper43_Init(); return &g_NESmapper;
      case 44:        NES_mapper44_Init(); return &g_NESmapper;
      case 45:        NES_mapper45_Init(); return &g_NESmapper;
      case 46:        NES_mapper46_Init(); return &g_NESmapper;
      case 47:        NES_mapper47_Init(); return &g_NESmapper;
      case 48:        NES_mapper48_Init(); return &g_NESmapper;
      case 49:        NES_mapper49_Init(); return &g_NESmapper;
      case 50:        NES_mapper50_Init(); return &g_NESmapper;
      case 51:        NES_mapper51_Init(); return &g_NESmapper;
      case 52:        NES_mapper52_Init(); return &g_NESmapper;
      case 57:        NES_mapper57_Init(); return &g_NESmapper;
      case 58:        NES_mapper58_Init(); return &g_NESmapper;
      case 60:        NES_mapper60_Init(); return &g_NESmapper;
      case 62:        NES_mapper62_Init(); return &g_NESmapper;
      case 64:        NES_mapper64_Init(); return &g_NESmapper;
      case 65:        NES_mapper65_Init(); return &g_NESmapper;
      case 66:        NES_mapper66_Init(); return &g_NESmapper;
      case 67:        NES_mapper67_Init(); return &g_NESmapper;
      case 68:        NES_mapper68_Init(); return &g_NESmapper;
      case 69:        NES_mapper69_Init(); return &g_NESmapper;
      case 70:        NES_mapper70_Init(); return &g_NESmapper;
      case 71:        NES_mapper71_Init(); return &g_NESmapper;
      case 72:        NES_mapper72_Init(); return &g_NESmapper;
      case 73:        NES_mapper73_Init(); return &g_NESmapper;
      case 74:        NES_mapper74_Init(); return &g_NESmapper;
      case 75:        NES_mapper75_Init(); return &g_NESmapper;
      case 76:        NES_mapper76_Init(); return &g_NESmapper;
      case 77:        NES_mapper77_Init(); return &g_NESmapper;
      case 78:        NES_mapper78_Init(); return &g_NESmapper;
      case 79:        NES_mapper79_Init(); return &g_NESmapper;
      case 80:        NES_mapper80_Init(); return &g_NESmapper;
      case 82:        NES_mapper82_Init(); return &g_NESmapper;
      case 83:        NES_mapper83_Init(); return &g_NESmapper;
      case 85:        NES_mapper85_Init(); return &g_NESmapper;
      case 86:        NES_mapper86_Init(); return &g_NESmapper;
      case 87:        NES_mapper87_Init(); return &g_NESmapper;
      case 88:        NES_mapper88_Init(); return &g_NESmapper;
      case 89:        NES_mapper89_Init(); return &g_NESmapper;
      case 90:        NES_mapper90_Init(); return &g_NESmapper;
      case 91:        NES_mapper91_Init(); return &g_NESmapper;
      case 92:        NES_mapper92_Init(); return &g_NESmapper;
      case 93:        NES_mapper93_Init(); return &g_NESmapper;
      case 94:        NES_mapper94_Init(); return &g_NESmapper;
      case 95:        NES_mapper95_Init(); return &g_NESmapper;
      case 96:        NES_mapper96_Init(); return &g_NESmapper;
      case 97:        NES_mapper97_Init(); return &g_NESmapper;
      case 99:        NES_mapper99_Init(); return &g_NESmapper;
      case 100:        NES_mapper100_Init(); return &g_NESmapper;
      case 101:        NES_mapper101_Init(); return &g_NESmapper;
      case 105:        NES_mapper105_Init(); return &g_NESmapper;
      case 112:        NES_mapper112_Init(); return &g_NESmapper;
      case 113:        NES_mapper113_Init(); return &g_NESmapper;
      case 114:        NES_mapper114_Init(); return &g_NESmapper;
      case 115:        NES_mapper115_Init(); return &g_NESmapper;
      case 117:        NES_mapper117_Init(); return &g_NESmapper;
      case 118:        NES_mapper118_Init(); return &g_NESmapper;
      case 119:        NES_mapper119_Init(); return &g_NESmapper;
      case 122:        NES_mapper122_Init(); return &g_NESmapper;
      case 140:        NES_mapper140_Init(); return &g_NESmapper;
      case 151:        NES_mapper151_Init(); return &g_NESmapper;
      case 160:        NES_mapper160_Init(); return &g_NESmapper;
      case 180:        NES_mapper180_Init(); return &g_NESmapper;
      case 181:        NES_mapper181_Init(); return &g_NESmapper;
      case 182:        NES_mapper182_Init(); return &g_NESmapper;
      case 183:        NES_mapper183_Init(); return &g_NESmapper;
      case 184:        //		NES_mapper184_Init(); return &g_NESmapper;
        NES_mapper122_Init(); return &g_NESmapper;
      case 185:        NES_mapper185_Init(); return &g_NESmapper;
      case 187:        NES_mapper187_Init(); return &g_NESmapper;
      case 188:        NES_mapper188_Init(); return &g_NESmapper;
      case 189:        NES_mapper189_Init(); return &g_NESmapper;
      case 222:        NES_mapper222_Init(); return &g_NESmapper;
      case 225:        NES_mapper225_Init(); return &g_NESmapper;
      case 226:        NES_mapper226_Init(); return &g_NESmapper;
      case 227:        NES_mapper227_Init(); return &g_NESmapper;
      case 228:        NES_mapper228_Init(); return &g_NESmapper;
      case 229:        NES_mapper229_Init(); return &g_NESmapper;
      case 230:        NES_mapper230_Init(); return &g_NESmapper;
      case 231:        NES_mapper231_Init(); return &g_NESmapper;
      case 232:        NES_mapper232_Init(); return &g_NESmapper;
      case 233:        NES_mapper233_Init(); return &g_NESmapper;
      case 234:        NES_mapper234_Init(); return &g_NESmapper;
      case 235:        NES_mapper235_Init(); return &g_NESmapper;
      case 236:        NES_mapper236_Init(); return &g_NESmapper;
      case 237:        NES_mapper237_Init(); return &g_NESmapper;
      case 240:        NES_mapper240_Init(); return &g_NESmapper;
      case 241:        NES_mapper241_Init(); return &g_NESmapper;
      case 242:        NES_mapper242_Init(); return &g_NESmapper;
      case 243:        NES_mapper243_Init(); return &g_NESmapper;
      case 244:        NES_mapper244_Init(); return &g_NESmapper;
      case 245:        NES_mapper245_Init(); return &g_NESmapper;
      case 246:        NES_mapper246_Init(); return &g_NESmapper;
      case 248:        NES_mapper248_Init(); return &g_NESmapper;
      case 249:        NES_mapper249_Init(); return &g_NESmapper;
      case 250:        NES_mapper250_Init(); return &g_NESmapper;
      case 251:        NES_mapper251_Init(); return &g_NESmapper;
      case 252:        NES_mapper252_Init(); return &g_NESmapper;
      case 254:        NES_mapper254_Init(); return &g_NESmapper;
      case 255:        NES_mapper255_Init(); return &g_NESmapper;
      case 12:        NES_mapperNSF_Init(); return &g_NESmapper;
